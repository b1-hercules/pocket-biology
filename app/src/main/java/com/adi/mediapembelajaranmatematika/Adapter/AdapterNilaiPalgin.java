...
public class AdapterNilaiPalgin extends RecyclerView.Adapter<AdapterNilaiPalgin.DataHolder> {

    private ArrayList<DaftarNilaiModels> listdatanilai;
    private Context context;

    public AdapterNilaiPalgin(ArrayList<DaftarNilaiModels> listdatanilai, Context context) {
